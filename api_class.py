...
class API:
    ...
    def get_release_info(self, movie_id):
        url = "https://api.themoviedb.org/3/movie/" + str(movie_id) + \
              "/release_dates?api_key="+self.api_token
    ...
    def get_episode_videos(self, show_id, season_number, episode_number):
        url = "https://api.themoviedb.org/3/tv/" + str(show_id) + \
              "/season/" + str(season_number) + "/episode/"\
              + str(episode_number) + "/videos?api_key="+self.api_token\
              + "&language=en-US"
    ...
    def get_episode_info(self, show_id, season_number, episode_number):
        url = "https://api.themoviedb.org/3/tv/" + str(show_id) \
              ...
              "/episode/" + str(episode_number) + "?api_key=" \
              + self.api_token + "&language=en-US"
