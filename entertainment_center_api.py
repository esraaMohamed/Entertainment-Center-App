...
beauty_and_the_beast = extractor.get_movie_data(media.MOVIE_IDS["Beauty and the Beast"])
boss_baby = extractor.get_movie_data(media.MOVIE_IDS["The Boss Baby"])
secret_life_of_pets = extractor.get_movie_data(media.MOVIE_IDS["Secret Life of Pets"])
...
movies = [home_again, table_19, the_circle, gifted, boss_baby, secret_life_of_pets,
          despicable_me_3, justice_league, beauty_and_the_beast, seinfield, friends, got]
